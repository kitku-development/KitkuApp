...
public class ListItemCategoryCardViewDataModel {
    ...
    private int image_category_item;
    ...
    public ListItemCategoryCardViewDataModel(int image_category_item, String text_name_category_item, String text_price_category_item, String text_pack_category_item) {
    ...
    public int getImage_category_item() {
    ...
    public void setImage_category_item(int image_category_item) {
        this.image_category_item = image_category_item;
    }
